...
Generated from the `trader.provider` signal registry; do not edit this file by hand.

This catalog contains the technical signals supported by stored market bars and the
day-constant calendar/event signals under `architecture.md` section 8.
"""
